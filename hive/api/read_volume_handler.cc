...
void read_volume_handler::check_read_cmd(hive_read_command& read_cmd){
...
future<std::unique_ptr<reply>>
read_volume_handler::read_by_volume_stream(
...
future<std::unique_ptr<reply> > read_volume_handler::handle(
    const sstring& path
