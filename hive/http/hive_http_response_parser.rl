...
http_status = (digit digit digit) > { _rsp->_status_code = 0; } ${ _rsp->_status_code *= 10; _rsp->_status_code += fc - '0'; };
...
class hive_response_parser : public ragel_parser_base<hive_response_parser> {
...
public:
    ...
    std::unique_ptr<hive_response> _rsp;
    sstring _field_name;
    sstring _value;
    state _state;
public:
